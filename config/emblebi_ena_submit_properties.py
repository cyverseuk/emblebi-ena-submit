...
private_key_path = base_script_dir + ".ssh/id_rsa_ena"
...
analysis_schema_path = schemas_dir + "SRA.analysis.xsd"
common_schema_path = schemas_dir + "SRA.common.xsd"
experiment_schema_path = schemas_dir + "SRA.experiment.xsd"
receipt_schema_path = schemas_dir + "SRA.receipt.xsd"
run_schema_path = schemas_dir + "SRA.run.xsd"
sample_schema_path = schemas_dir + "SRA.sample.xsd"
study_schema_path = schemas_dir + "SRA.study.xsd"
#bioproject_schema_path = schemas_dir + "bioproject.xsd"
#biosample_schema_path = schemas_dir + "biosample.xsd"

ena_user = "Webin-39233"
ena_host = "webin.ebi.ac.uk"
# ncbi_sumbit_path = "submit/Production"
ena_sumbit_path = "submit/Test"
